...
<head>
  ...
  <title>Aplikasi Permudah Tinggalkan Kelas</title>
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.html" class="text-nowrap logo-img">
            <img src="assets/images/logos/Logo1-eazyn.png" width="120px" height="40px" />
          </a>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="card overflow-hidden">
                  <div class="card-body p-4">
                    <h5 class="card-title mb-9 fw-semibold">Tersedia</h5>
                    <div class="row align-items-center">
                      <div class="col-4">
                        <?php
                        $query = "select value from setting where nama_setting = 'pembatasan'";
                        $queryy = "select count(id) as jumlah_izin from izin where siswa_id = 2 and is_approved = 2";
                        $sql = mysqli_query($is_connect, $query);
                        $sql1 = mysqli_query($is_connect, $queryy);
                        $fetch_data = mysqli_fetch_all($sql, MYSQLI_ASSOC);
