    ...
    <div>
      ...
      <div class="brand-logo d-flex align-items-center justify-content-between">
        <a href="./index.html" class="text-nowrap logo-img">
          <img src="../assets/images/logos/eazyn.png" width="180" alt="" />
        </a>
      ...
      <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
        <ul id="sidebarnav">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="./buat-izin.html" aria-expanded="false">
      ...
      <div class="card w-100">
        <div class="card-body">
          <form>
            ...
            <div class="mb-3">
              <label for="exampleInputEmail" class="form-label">Pilih Guru</label>
            ...
            <div class="mb-3">
              ...
              <input type="password" class="form-control" id="exampleInputPassword1" name="alasan">
            </div>
            ...
            <div class="mb-3">
              ...
              <select class="form-select" aria-label="Default select example" name="sampai_jam">
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
                <option value="4">4</option>
            ...
            <div class="mb-3">
  <label for="exampleInputPassword1" class="form-label">File Pendukung</label>
  <input class="form-control" type="file" id="formFile" name="file_pendukung">
</div>
